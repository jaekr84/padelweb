    ...
    return (
        <nav className="fixed top-0 w-full z-50 p-4 lg:p-6 flex justify-center">
            <motion.div
                ...
                className="flex justify-between items-center w-full max-w-7xl bg-slate-900/60 backdrop-blur-xl border border-blue-500/20 rounded-[2rem] px-6 py-3 shadow-[0_0_30px_rgba(59,130,246,0.1)]"
            >
                <Link href="/" className="flex items-center gap-3 flex-1 group">
                    ...
                    <span className="font-black text-xl italic tracking-tighter text-white group-hover:text-celeste transition-colors">A.C.A.P</span>
                </Link>
                ...
                <div className="hidden lg:flex gap-8 items-center justify-center flex-[2]">
                    ...
                    <Link href="/contacto" className="text-[10px] font-black tracking-[0.2em] text-slate-400 hover:text-white transition-all uppercase flex items-center gap-2 group">
