      ...
      <AnimatePresence mode="wait">
        {viewMode === "grid" ? (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className={`grid gap-2 rounded-2xl overflow-hidden border border-white/10 bg-white/5 relative group/media
                            ${
                              count === 1
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="relative bg-white/5 rounded-2xl overflow-hidden aspect-square flex flex-col items-center justify-center p-4 group/carousel border border-white/10"
          >
            {/* Back to Grid Button */}
            <button
              onClick={() => setViewMode("grid")}
              className="absolute top-4 left-4 z-20 px-4 py-2 bg-white/80 hover:bg-carbon-800 text-slate-200 rounded-xl backdrop-blur-md text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 border border-white/10 shadow-sm"
            >
              <ChevronLeft className="w-3 h-3" /> Volver
            </button>

            {/* Image Counter */}
            <div className="absolute top-4 right-4 z-20 px-3 py-1.5 bg-white/80 backdrop-blur-md text-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest border border-white/10 shadow-sm">
            ...
            {count > 1 && (
              <>
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 hover:bg-carbon-800 text-slate-200 rounded-full flex items-center justify-center backdrop-blur-md shadow-md transition-all z-20"
                >
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 hover:bg-carbon-800 text-slate-200 rounded-full flex items-center justify-center backdrop-blur-md shadow-md transition-all z-20"
                >
