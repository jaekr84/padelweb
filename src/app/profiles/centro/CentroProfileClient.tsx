            ...
            <div className={`max-w-4xl mx-auto w-full flex flex-col gap-6`}>
                ...
                <div className="bg-card backdrop-blur-3xl border border-border rounded-[2rem] overflow-hidden shadow-2xl relative">
                    ...
                    <div className="absolute top-4 right-4 z-10">
                        {isOwner && (
                            <button
                                className="flex items-center gap-1.5 bg-muted/80 backdrop-blur-md border border-border text-foreground px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest cursor-pointer transition-all hover:bg-muted active:scale-95 shadow-lg"
                        ...
                        <div className="flex-1 text-center md:text-left pt-2 pb-1">
                            <div className="flex flex-col md:flex-row md:items-center gap-3 mb-2 justify-center md:justify-start">
                                ...
                                <div className="flex self-center md:self-auto px-3 py-1 bg-indigo-500/10 dark:bg-indigo-500/20 border border-indigo-500/20 dark:border-indigo-500/30 rounded-full">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Centro de Pádel</span>
                                </div>
                            </div>
                ...
                <div className="flex items-center gap-2 bg-card p-1.5 rounded-[1.5rem] border border-border overflow-x-auto no-scrollbar shadow-inner">
                    ...
                    <button
                        className={`flex-1 min-w-[100px] px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === "photos" ? "bg-indigo-600 text-white shadow-xl shadow-indigo-900/40" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`}
                    ...
                    <button
                        className={`flex-1 min-w-[100px] px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === "schedule" ? "bg-indigo-600 text-white shadow-xl shadow-indigo-900/40" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`}
                ...
                <div className="animate-in slide-in-from-bottom-4 duration-500">
                    {activeTab === "info" && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="md:col-span-2 flex flex-col gap-6">
                                ...
                                <div className="bg-card border border-border p-8 rounded-[2rem] shadow-xl">
                                    <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground mb-4">Amenidades</h3>
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="bg-card border border-border p-8 rounded-[2rem] shadow-xl flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className="flex items-center gap-3 text-foreground/80">
                                            <div className="w-10 h-10 rounded-2xl bg-card flex items-center justify-center border border-border"><Instagram className="h-4 w-4" /></div>
                                            <span className="text-sm font-bold tracking-tight italic">@{centro?.instagram || "-"}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-card border border-border p-8 rounded-[2rem] shadow-xl flex flex-col gap-6">
                                    <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Dirección</h3>
                                    <div className="flex flex-col gap-2">
                                        <p className="text-sm font-bold tracking-tight text-foreground/80">{centro?.address || "No especificada"}</p>
                                        <span className="text-[10px] font-black uppercase text-muted-foreground">{centro?.location}</span>
                                    </div>
                                </div>
                    ...
                    {activeTab === "photos" && (
                        <div className="bg-card border border-border p-8 rounded-[2rem] shadow-xl">
                            {photos.length === 0 ? (
                                <div className="p-16 border-2 border-dashed border-border rounded-[1.5rem] flex flex-col items-center gap-4 text-center">
                                    <Camera className="h-12 w-12 text-muted-foreground/40" />
                                    <p className="text-muted-foreground text-sm font-medium">No hay fotos en la galería.</p>
                                </div>
                            ) : (
                            ...
                            <div className="bg-card border border-border p-8 rounded-[2rem] shadow-xl flex flex-col gap-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">Escuela de Menores y Adultos</p>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-4 mt-2">
                                    <div className="p-4 bg-card rounded-2xl border border-border/50 hover:border-indigo-500/30 transition-all">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Escualita de Menores</span>
                                            <span className="text-[10px] font-bold text-muted-foreground/60 italic">6-14 años</span>
                                        </div>
                                        <p className="text-xs text-foreground/80 leading-relaxed">Formación integral desde lo básico hasta la técnica competitiva.</p>
                                    </div>
                                    <div className="p-4 bg-card rounded-2xl border border-border/50 hover:border-indigo-500/30 transition-all">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400">Entrenamiento Adultos</span>
                                            <span className="text-[10px] font-bold text-muted-foreground/60 italic">Todos los Niveles</span>
                                        </div>
                                        <p className="text-xs text-foreground/80 leading-relaxed">Clases grupales y particulares adaptadas a tu ritmo de juego.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-card border border-border p-8 rounded-[2rem] shadow-xl flex flex-col gap-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">A.C.A.P. Performance</p>
                                    </div>
                                </div>
                                <div className="space-y-4 mt-2">
                                    <div className="flex items-start gap-4 p-4 hover:bg-muted rounded-2xl transition-all">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-foreground/50 leading-relaxed">Enfoque en desplazamientos eficientes y golpes de control.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-4 hover:bg-muted rounded-2xl transition-all">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-foreground/50 leading-relaxed">Situaciones de juego real para mejorar la toma de decisiones.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-card border border-border rounded-[2rem] p-8 shadow-xl">
                            <div className="flex flex-col gap-3">
                                {DAYS_OF_WEEK.map(({ key, label }) => {
                                    ...
                                    return (
                                        <div key={key} className="flex items-center justify-between py-4 border-b border-border/50 last:border-0 hover:bg-muted px-4 rounded-xl transition-colors group">
                                            <span className="text-xs font-black uppercase tracking-widest text-muted-foreground group-hover:text-foreground/80">{label}</span>
                                            <div className="flex items-center gap-4">
                                                {s?.closed ? (
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-red-500/50">Cerrado</span>
                                                ) : (
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-sm font-black italic tracking-tighter tabular-nums text-foreground/80">{s?.open || "08:00"}</span>
                                                        <div className="w-2 h-[1px] bg-border" />
                                                        <span className="text-sm font-black italic tracking-tighter tabular-nums text-foreground/80">{s?.close || "22:00"}</span>
                                                    </div>
                                                )}
                                                <div className="w-8 h-8 rounded-full bg-card flex items-center justify-center"><ClockIcon className="h-3.5 w-3.5 text-muted-foreground/60" /></div>
                                            </div>
                                        </div>
                                    );
                                })}
                ...
                {isEditing && (
                    <div className="fixed inset-0 bg-black/90 backdrop-blur-2xl z-[1000] flex items-center justify-center p-4">
                        <div className="bg-card border border-border rounded-[2.5rem] w-full max-w-[800px] max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200 shadow-2xl flex flex-col">
                            <div className="px-8 pt-8 pb-4 flex justify-between items-center sticky top-0 bg-card/80 backdrop-blur-lg z-10 border-b border-border/50">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[8px] font-black uppercase tracking-[0.3em] text-muted-foreground">Configuración Profesional</span>
                                </div>
                                <button onClick={() => setIsEditing(false)} className="w-10 h-10 rounded-full bg-card hover:bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-all">✕</button>
                            </div>
                            ...
                            <div className="p-8 flex flex-col gap-10">
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex justify-between items-center">
                                        <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground px-2">Galería de Fotos ({photos.length}/5)</h3>
                                        <button
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="flex flex-col gap-6">
                                        <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground px-2 border-l-2 border-indigo-500">Básico</h3>
                                        <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[10px] font-black uppercase text-muted-foreground ml-2">Descripción</label>
                                            <textarea value={formData.bio} onChange={e => setFormData({ ...formData, bio: e.target.value })} rows={3} className="w-full bg-card border border-border rounded-2xl py-4 px-5 text-foreground text-sm font-bold outline-none focus:border-indigo-500 shadow-inner resize-none" />
                                        </div>
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="flex flex-col gap-2">
                                                <label className="text-[10px] font-black uppercase text-muted-foreground ml-2">Barrio</label>
                                                <input type="text" value={formData.location} onChange={e => setFormData({ ...formData, location: e.target.value })} className="w-full bg-card border border-border rounded-2xl py-4 px-5 text-foreground text-sm font-bold outline-none focus:border-indigo-500" />
                                            </div>
                                            <div className="flex flex-col gap-2">
                                                <label className="text-[10px] font-black uppercase text-muted-foreground ml-2">Canchas</label>
                                                <input type="number" value={formData.courts} onChange={e => setFormData({ ...formData, courts: Number(e.target.value) })} className="w-full bg-card border border-border rounded-2xl py-4 px-5 text-foreground text-sm font-bold outline-none focus:border-indigo-500" />
                                            </div>
                                        </div>
                                    </div>

                                    <div className="flex flex-col gap-6">
                                        <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground px-2 border-l-2 border-indigo-500">Legal y Redes</h3>
                                        <div className="flex flex-col gap-1">
                                            <div className="flex flex-col gap-2 mb-2">
                                                <label className="text-[10px] font-black uppercase text-muted-foreground ml-2">Dirección Completa</label>
                                                <input type="text" value={formData.address} onChange={e => setFormData({ ...formData, address: e.target.value })} className="w-full bg-card border border-border rounded-2xl py-4 px-5 text-foreground text-sm font-bold outline-none focus:border-indigo-500" />
                                            </div>
                                            <div className="flex flex-col gap-2 mb-2">
                                                <label className="text-[10px] font-black uppercase text-muted-foreground ml-2">Teléfono / WhatsApp</label>
                                ...
                                {/* Horarios */}
                                <div className="flex flex-col gap-4">
                                    <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground px-2 border-l-2 border-indigo-500">Horarios de Apertura</h3>
                                    <div className="bg-card border border-border rounded-[2rem] overflow-hidden">
                                        {DAYS_OF_WEEK.map(({ key, label }) => (
                                            <div key={key} className="flex items-center justify-between p-4 border-b border-border/50 last:border-0 hover:bg-muted transition-colors">
                                                <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground min-w-[100px]">{label}</span>
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        type="time"
                                                        ...
                                                        className="bg-card border border-border rounded-xl px-2 py-1 text-xs font-bold text-foreground/80 disabled:opacity-20"
                                                    />
                                                    ...
                                                    <label className="flex items-center gap-2 ml-4 cursor-pointer">
                                                        ...
                                                        />
                                                        <div className="w-8 h-4 bg-muted peer-checked:bg-red-500/50 rounded-full relative transition-all after:content-[''] after:absolute after:top-1 after:left-1 after:w-2 after:h-2 after:bg-foreground after:rounded-full after:transition-all peer-checked:after:left-5"></div>
                                                        <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/60 peer-checked:text-red-500">Cerrado</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ))}
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-6">
                                    <button onClick={() => setIsEditing(false)} className="bg-card text-foreground/80 border border-border py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-muted transition-all">Descartar</button>
                                    <button onClick={handleSave} disabled={saving} className="bg-indigo-600 hover:bg-indigo-500 text-foreground py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-xl shadow-indigo-900/40 disabled:opacity-50">
