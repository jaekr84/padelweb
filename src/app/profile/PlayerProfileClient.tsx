                                    ...
                                    <div className="max-w-2xl mx-auto">
                                        <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 md:p-12 shadow-2xl">
                                            ...
                                            <p className="text-white/50 text-xs font-medium mb-8 leading-relaxed uppercase tracking-widest">
                                                Envía un correo de invitación para que un nuevo usuario se registre con el rol de <span className="text-indigo-400 font-black">CLUB / CENTRO</span>. Al aceptar la invitación, el rol se asignará automáticamente.
                                            </p>
                                            ...
                                            <div className="flex flex-col gap-6">
                                                <div className="bg-white/5 border border-white/10 rounded-3xl p-6 relative overflow-hidden group">
                                                    ...
                                                    <p className="mt-4 text-[9px] text-white/20 font-medium leading-relaxed italic">
                                                        * Este link redirige al onboarding del usuario con el rol de <span className="text-white/40">Club</span> pre-seleccionado.
                                                    </p>
                                                </div>

                                                <div className="flex items-center gap-4 py-2">
                                                    <div className="h-px flex-1 bg-white/5" />
                                                    <span className="text-[9px] font-black text-white/10 uppercase tracking-[0.3em]">o vía email</span>
                                                    <div className="h-px flex-1 bg-white/5" />
                                                </div>
                                                ...
                                                >
                                                    <div className="flex flex-col gap-2">
                                                        <label className="text-[10px] font-black uppercase text-white/30 ml-2">Correo del Club</label>
                                                        <div className="relative group">
                                                            <input
                                                                type="email"
                                                                name="email"
                                                                ...
                                                                required
                                                                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white text-sm font-bold outline-none focus:border-indigo-500 transition-all shadow-inner group-hover:bg-white/[0.07]"
                                                            />
                                                        </div>
                                                    </div>
