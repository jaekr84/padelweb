...
export default function OpenCourtPublicClient({ initialEvents, userRegistrations, isLoggedIn, currentUserId, userRole }: OpenCourtPublicClientProps) {
    ...
    const dropdownContentStyles = "z-50 overflow-hidden rounded-xl border border-border bg-card shadow-2xl animate-in fade-in zoom-in-95 duration-200";
    const dropdownViewportStyles = "p-1";
    const dropdownItemStyles = "relative flex cursor-default select-none items-center rounded-lg px-4 py-2 text-[10px] font-black tracking-widest uppercase text-foreground outline-none transition-colors data-[highlighted]:bg-azul-primary/10 data-[highlighted]:text-azul-primary data-[state=checked]:bg-azul-primary data-[state=checked]:text-white";
    ...
    return (
        <div className="relative min-h-screen font-sans selection:bg-azul-primary/30">
            ...
            <div className="relative z-10 max-w-[1600px] mx-auto px-4 py-4 md:py-6 space-y-5">
                ...
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-azul-primary">ACAP</span>
                            <div className="h-px w-6 bg-azul-primary/30" />
                        </div>
                        <div>
                            <h1 className="text-2xl md:text-3xl font-black uppercase italic tracking-tight leading-none text-foreground">
                    ...
                    {userRole === "club" && (
                        <Link href="/admin/cancha-abierta/create">
                            <button className="group bg-azul-primary hover:bg-azul-dark text-white pl-4 pr-3 py-2 rounded-xl font-black text-[9px] uppercase tracking-widest transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-azul-primary/20 flex items-center gap-3 shrink-0">
                                Crear Evento
                ...
                <div className="relative bg-card border border-border/80 rounded-xl overflow-hidden shadow-sm">
                    <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-muted-foreground/20 pointer-events-none" />
                    <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-muted-foreground/20 pointer-events-none" />
                    <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-muted-foreground/20 pointer-events-none" />
                    <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-muted-foreground/20 pointer-events-none" />
                    <div className="flex items-center divide-x divide-border/60 overflow-x-auto">
                        {[
                            ...
                            { icon: Trophy, color: "text-muted-foreground/50", value: pastEvents.length, label: "Finalizados" },
                            ...
                            <div key={i} className="flex items-center gap-2 px-4 py-2 shrink-0 group hover:bg-muted/20 transition-colors">
                                ...
                                <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/60 leading-none">{kpi.label}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="relative bg-card border border-border/80 rounded-xl overflow-hidden shadow-sm flex items-center divide-x divide-border/60">
                    <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-muted-foreground/20 pointer-events-none z-10" />
                    <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-muted-foreground/20 pointer-events-none z-10" />
                    <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-muted-foreground/20 pointer-events-none z-10" />
                    <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-muted-foreground/20 pointer-events-none z-10" />
                    ...
                    <div className="relative flex-1 min-w-0">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent py-2 pl-8 pr-3 text-[9px] font-bold uppercase tracking-widest text-foreground focus:outline-none placeholder-muted-foreground/40 h-8 transition-all"
                        />
                    </div>

                    {/* City Select */}
                    <Select.Root value={cityQuery} onValueChange={(value) => setCityQuery(value === "__empty__" ? "" : value)}>
                        <Select.Trigger className="flex items-center gap-1.5 px-3 h-8 text-[9px] font-bold uppercase tracking-widest text-foreground focus:outline-none transition-all hover:bg-muted/30 shrink-0 bg-transparent w-36">
                    ...
                    <Select.Root value={sortBy} onValueChange={(value) => setSortBy(value)}>
                        <Select.Trigger className="flex items-center gap-1.5 px-3 h-8 text-[9px] font-bold uppercase tracking-widest text-foreground focus:outline-none transition-all hover:bg-muted/30 shrink-0 bg-transparent w-40">
                    ...
                    <div className="flex items-center shrink-0">
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 h-8 text-[9px] font-black uppercase tracking-widest transition-all ${viewMode === "grid" ? "bg-azul-primary/10 text-azul-primary" : "text-muted-foreground/60 hover:text-foreground hover:bg-muted/20"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 h-8 text-[9px] font-black uppercase tracking-widest transition-all ${viewMode === "table" ? "bg-orange-500/10 text-orange-500" : "text-muted-foreground/60 hover:text-foreground hover:bg-muted/20"
                                }`}
                        >
                ...
                <div className="space-y-4">
                    ...
                    {viewMode === "grid" ? (
                        ...
                        <div className="bg-card border border-border/80 rounded-2xl overflow-hidden shadow-xl animate-in fade-in duration-300">
                            <div className="overflow-x-auto">
                                <table className="w-full text-left border-collapse min-w-[600px]">
                                    <thead>
                                        <tr className="border-b border-border bg-muted/20 text-[8px] font-black tracking-widest uppercase text-muted-foreground/80 h-9">
                                    ...
                                    <tbody>
                                        {upcomingEvents.map((event) => {
                                            ...
                                            return (
                                                <tr key={event.id} className="border-b border-border hover:bg-muted/10 transition-colors h-14 text-xs">
                                                    {/* Club / Name */}
                                                    <td className="px-4 py-2 min-w-[200px]">
                                                        <div className="flex items-center gap-2.5">
                                                            ...
                                                            <div className="min-w-0">
                                                                ...
                                                                <p className="text-[8px] font-black uppercase tracking-wider text-muted-foreground/60 truncate">
                                                                    {event.club.name}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td className="px-4 py-2">
                                                        <div className="flex flex-col gap-1 w-28">
                                                            <div className="flex items-center justify-between text-[9px] font-black font-mono">
                                                                <span className="text-foreground/80">{event.registrationCount} / {event.totalSlots || 0}</span>
                                                                <span className="text-muted-foreground/60">{Math.round(percent)}%</span>
                                                            </div>
                                                            <div className="h-1 w-full bg-muted border border-border/40 rounded-full overflow-hidden">
                                                                <div
                                                    ...
                                                    <td className="px-4 py-2 text-right">
                                                        <div className="flex items-center justify-end gap-1.5">
                                                            ...
                                                            <button
                                                                ...
                                                                className="h-7 px-2 bg-card hover:bg-muted/50 border border-border text-muted-foreground hover:text-foreground rounded text-[8px] font-black uppercase tracking-widest transition-all flex items-center gap-1"
                                                            ...
                                                            {isLoggedIn && (event.creatorId || event.club?.ownerId) && currentUserId !== (event.creatorId || event.club?.ownerId) && (
                                                                <button
                                                                    ...
                                                                    className="h-7 w-7 bg-card hover:bg-muted/50 border border-border text-muted-foreground hover:text-azul-primary rounded flex items-center justify-center transition-all"
                                        ...
                                        {upcomingEvents.length === 0 && (
                                            <tr>
                                                <td colSpan={5} className="py-12 text-center">
                                                    ...
                                                    <h4 className="text-xs font-black uppercase tracking-tighter italic text-muted-foreground/50">Sin eventos disponibles</h4>
                ...
                {pastEvents.length > 0 && (
                    <div className="pt-12 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                        ...
                        {viewMode === "grid" ? (
                            ...
                            <div className="bg-card border border-border/80 rounded-2xl overflow-hidden shadow-xl opacity-90">
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left border-collapse min-w-[600px]">
                                        <thead>
                                            <tr className="border-b border-border bg-muted/20 text-[8px] font-black tracking-widest uppercase text-muted-foreground/80 h-9">
                                            ...
                                            {pastEvents.map((event) => {
                                                ...
                                                return (
                                                    <tr key={event.id} className="border-b border-border hover:bg-muted/10 transition-colors h-14 text-xs">
                                                        <td className="px-4 py-2">
                                                            <div className="flex items-center gap-2.5">
                                                                <div className="w-7 h-7 rounded-lg bg-muted border border-border flex items-center justify-center shrink-0 text-[10px] font-black uppercase text-muted-foreground overflow-hidden">
                                                                    {event.club.image ? (
                                                                        <img src={event.club.image} alt={event.club.name || ""} className="w-full h-full object-cover" />
                                                                    ) : (
                                                                        (event.club.name || "C").charAt(0)
                                                        ...
                                                        <td className="px-4 py-2 font-mono text-[10px] text-muted-foreground/75">
                                                            <div className="flex flex-col">
                                                        ...
                                                        <td className="px-4 py-2 font-mono text-[10px] text-muted-foreground/70">
                                                            <span className="font-bold">{event.registrationCount}</span> asistencias
                                                        </td>
                                                        <td className="px-4 py-2">
                                                            <span className="inline-flex items-center px-1.5 py-0.5 rounded border border-muted-foreground/20 text-muted-foreground bg-muted-foreground/5 text-[7px] font-black uppercase tracking-widest">
                                                                Finalizado
                                                            </span>
                                                        </td>
                                                        <td className="px-4 py-2 text-right">
            ...
            <div className="max-w-[1600px] mx-auto px-4 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-6">
                    {[
                        ...
                        <div key={i} className="group relative bg-card hover:bg-azul-primary/[0.02] border border-border rounded-xl p-4 flex items-center gap-3 transition-all duration-300 shadow-sm hover:shadow-md hover:border-azul-primary/20">
                            <div className="absolute top-0 left-0 w-1.5 h-1.5 border-t border-l border-muted-foreground/20 pointer-events-none" />
                            <div className="absolute bottom-0 right-0 w-1.5 h-1.5 border-b border-r border-muted-foreground/20 pointer-events-none" />
                            <div className={`w-8 h-8 rounded-lg bg-muted flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform ${item.color}`}>
                ...
                {isParticipantsModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-2xl bg-card border border-border/80 rounded-2xl overflow-hidden shadow-2xl flex flex-col max-h-[85vh] z-10"
                        >
                            ...
                            {/* Header */}
                            <div className="p-4 border-b border-border/70 flex items-center justify-between bg-muted/10 shrink-0">
                                <div>
                                ...
                                <button
                                    onClick={() => setIsParticipantsModalOpen(false)}
                                    className="h-8 w-8 rounded-lg bg-muted hover:bg-muted/80 text-muted-foreground hover:text-foreground flex items-center justify-center transition-all border border-border/40"
                                >
                                    <X className="w-4 h-4" />
                                </button>
                            </div>
                            ...
                            <div className="p-3 bg-muted/20 border-b border-border/60 shrink-0">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-lg border border-border bg-card py-2 pl-9 pr-4 text-[10px] font-bold uppercase tracking-widest text-foreground focus:outline-none focus:ring-1 focus:ring-azul-primary/30 placeholder-muted-foreground/50 h-8.5 transition-all"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto p-4 min-h-[250px]">
                                {isLoadingRegistrations ? (
                                    <div className="h-full flex flex-col items-center justify-center py-16 space-y-3">
                                        ...
                                        <span className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/75">Cargando inscriptos...</span>
                                    </div>
                                    ...
                                    <div className="py-16 flex flex-col items-center justify-center space-y-3 bg-muted/10 border border-dashed border-border rounded-xl">
                                        <Search className="w-8 h-8 text-muted-foreground/20" />
                                        <div className="text-center">
                                            <h4 className="text-xs font-black uppercase tracking-tight italic text-muted-foreground/60">Sin inscriptos</h4>
                            ...
                            {/* Footer */}
                            <div className="p-3 border-t border-border/70 bg-muted/10 text-right shrink-0 flex items-center justify-between">
                                <span className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/75 font-mono">
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-[250px]">
                                {isLoadingResults ? (
                                    <div className="h-full flex flex-col items-center justify-center py-16 space-y-3">
                                        <div className="w-6 h-6 border-2 border-celeste border-t-transparent rounded-full animate-spin" />
                                        <span className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/75">Cargando reporte de partidos...</span>
                                    </div>
                                    ...
                                    <>
                                        ...
                                        <div className="grid grid-cols-1 gap-2.5">
                                            {filteredMatches.map((match) => (
                                                <div
                                                    key={match.id}
                                                    className="bg-card/70 border border-border/80 p-3.5 rounded-xl flex flex-col gap-2.5 relative overflow-hidden transition-all duration-300 hover:border-celeste/35"
                                                    style={{
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center justify-between border-b border-border/60 pb-1.5">
                                                        <span className="text-[7px] font-black uppercase tracking-[0.25em] text-muted-foreground/75 flex items-center gap-1">
                                                            <Zap className="w-2.5 h-2.5 text-orange-500" />
                                                            Cancha {match.courtNumber || 1}
                                                        </span>
                                                        {match.finishedAt && (
                                                            <span className="text-[7px] font-bold font-mono text-muted-foreground/60">
                                    ...
                                    <div className="py-16 flex flex-col items-center justify-center space-y-3 bg-muted/10 border border-dashed border-border rounded-xl">
                                        ...
                                        <div className="text-center">
                                            <h4 className="text-xs font-black uppercase tracking-tight italic text-muted-foreground/60">Sin partidos registrados</h4>
