            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 pt-16 md:pt-24 pb-32">
                ...
                <header className="mb-20 text-center md:text-left">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-celeste/10 border border-celeste/20 text-celeste text-[10px] font-black uppercase tracking-[0.3em] mb-6 shadow-lg shadow-celeste/10 backdrop-blur-md"
                    >
                ...
                >
                    ...
                    <motion.section variants={item} className="glass-card rounded-[3rem] p-8 md:p-14 relative overflow-hidden group shadow-2xl">
                        <div className="absolute top-0 right-0 p-12 opacity-[0.03] group-hover:opacity-[0.08] transition-all duration-700 -rotate-12 translate-x-4">
                            <Star className="w-64 h-64 text-celeste" />
                        </div>

                        <div className="flex items-center gap-5 mb-12">
                            <div className="w-16 h-16 rounded-[1.5rem] bg-celeste/10 border border-celeste/20 flex items-center justify-center shadow-inner">
                                <Zap className="w-8 h-8 text-celeste" />
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                            <div className="space-y-6">
                                <h3 className="text-xs font-black uppercase tracking-[0.25em] text-celeste flex items-center gap-2 italic">Fases de Juego <div className="h-px bg-celeste/20 flex-1" /></h3>
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between p-5 bg-white/5 border border-white/5 rounded-2xl group hover:border-celeste/30 hover:bg-celeste/5 transition-all">
                            ...
                            <div className="space-y-6">
                                <h3 className="text-xs font-black uppercase tracking-[0.25em] text-azul-primary flex items-center gap-2 italic">Bonus Adicionales <div className="h-px bg-azul-primary/20 flex-1" /></h3>
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="flex flex-col p-5 bg-white/5 border border-white/5 rounded-2xl group hover:border-azul-primary/30 hover:bg-azul-primary/5 transition-all">
                        ...
                        <div className="pt-12 border-t border-white/5">
                            ...
                            <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden">
                                ...
                                <div className="mt-16 overflow-hidden rounded-[2.5rem] border border-black/5 bg-white/10">
                                    <div className="bg-white/5 px-8 py-5 border-b border-white/10 flex items-center justify-between">
                                        <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-celeste italic">Desglose de Distribución (Individual)</h4>
                                                    ...
                                                    <tr key={i} className={`group hover:bg-celeste/5 transition-colors ${row.highlight ? "bg-celeste/10" : ""}`}>
                                                        <td className="px-8 py-5">
                                                            <div className="flex items-center gap-3">
                                                                {row.highlight && <Trophy className="w-3.5 h-3.5 text-amber-400" />}
                                                                <span className={`text-[11px] font-black uppercase italic tracking-tight ${row.highlight ? "text-celeste" : "text-foreground"}`}>
                                                                    {row.rank}
                                                                </span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="px-8 py-5 text-center">
                                                            <span className={`px-4 py-1.5 rounded-full text-[11px] font-black italic tracking-tighter ${row.highlight ? "bg-celeste text-white" : "bg-white/5 text-foreground"}`}>
                                                                {row.total}
                                                            </span>
                                                        </td>
                                                    </tr>
                    ...
                    <motion.section variants={item} className="glass-card rounded-[3rem] p-8 md:p-14 relative overflow-hidden group shadow-2xl">
                        <div className="absolute top-0 right-0 p-12 opacity-[0.02] group-hover:opacity-[0.05] transition-all duration-700">
                            <TrendingUp className="w-80 h-80 text-rosa" />
                        </div>

                        <div className="flex items-center gap-5 mb-12">
                            <div className="w-16 h-16 rounded-[1.5rem] bg-rosa/10 border border-rosa/20 flex items-center justify-center shadow-inner">
                                <ArrowUpRight className="w-8 h-8 text-rosa" />
                            </div>
                            <div>
                                <h2 className="text-3xl font-black uppercase italic tracking-tighter text-rosa">Meritocracia & Ascenso</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                { title: "Superación del Umbral", desc: "Si tu puntaje acumulado supera el máximo de tu categoría por un 15% adicional, se procesa el ascenso por superioridad técnica.", icon: Star, color: "bg-rosa" },
                                { title: "Consistencia Élite", desc: "Alcanzar el umbral de puntos de la siguiente categoría sumado a haber ganado al menos 1 torneo oficial.", icon: Medal, color: "bg-celeste" },
                            ].map((card, i) => (
                                <div key={i} className="p-8 bg-white/5 border border-white/5 rounded-[2rem] flex flex-col gap-6 group hover:bg-rosa/5 hover:border-rosa/20 transition-all">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-black uppercase italic tracking-widest mb-3 group-hover:text-rosa transition-colors leading-tight">{card.title}</h4>
                    ...
                    <motion.section variants={item} className="glass-card rounded-[3rem] p-8 md:p-14 shadow-2xl relative overflow-hidden group border-rojo/10">
                        <div className="absolute bottom-0 right-0 p-12 opacity-[0.02] group-hover:opacity-[0.05] transition-all duration-700">
                            <TrendingDown className="w-80 h-80 text-rojo" />
                        </div>

                        <div className="flex items-center gap-5 mb-10">
                            <div className="w-16 h-16 rounded-[1.5rem] bg-rojo/10 border border-rojo/20 flex items-center justify-center">
                                <Clock className="w-8 h-8 text-rojo" />
                            </div>
                            <div>
                                <h2 className="text-3xl font-black uppercase italic tracking-tighter text-rojo">Penalización e Inactividad</h2>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-12">
                            <div className="flex-1 space-y-6">
                                <p className="text-lg font-bold text-muted-foreground leading-relaxed uppercase tracking-tight italic">
                                    Para asegurar que el ranking refleje el nivel real de los jugadores activos, hemos implementado el <strong className="text-rojo italic">— Descenso por Inactividad —</strong>.
                                </p>
                                <div className="p-8 bg-rojo/5 border border-rojo/10 rounded-[2rem] w-full group-hover:bg-rojo/10 transition-all">
                                    <div className="flex items-center gap-4 mb-4">
                                        <TrendingDown className="w-7 h-7 text-rojo" />
                            ...
                            <div className="w-full lg:w-72 p-10 glass-card rounded-[2.5rem] flex flex-col items-center justify-center text-center shadow-inner relative overflow-hidden group-hover:border-rojo/40 transition-all">
                                ...
                                <div className="text-6xl font-black italic tracking-tighter text-rojo mb-2 relative">365</div>
                    ...
                    <motion.section variants={item} className="glass-card rounded-[3rem] p-8 md:p-14 shadow-2xl relative overflow-hidden group">
                        <div className="flex items-center gap-5 mb-8">
                            <div className="w-16 h-16 rounded-[1.5rem] bg-azul-primary/5 border border-azul-primary/10 flex items-center justify-center shadow-inner group-hover:bg-azul-primary/10 transition-all">
                                <Users className="w-8 h-8 text-azul-primary transition-colors" />
                            </div>
                            <div>
                        ...
                        <p className="text-base font-bold text-muted-foreground leading-relaxed max-w-3xl uppercase tracking-tight italic opacity-70">
                            Existen casos excepcionales donde un jugador demuestra un <span className="text-celeste">nivel disruptivo</span> que no llega a cumplir las condiciones automáticas. Los administradores tienen la facultad de realizar promociones manuales basadas en la observación directa de su juego y competitividad real.
                        </p>
                    </motion.section>
                </motion.div>
                ...
                <footer className="mt-32 text-center pb-12">
                    <div className="h-px bg-gradient-to-r from-transparent via-azul-primary/10 to-transparent mb-12" />
                    <p className="text-[9px] font-black uppercase tracking-[0.5em] text-muted-foreground opacity-30 italic">
                        Plataforma Oficial de Ranking de Padel <span className="text-azul-primary/50">//</span> Pro-System v2.4
                    </p>
                </footer>
            </div>
        </div>
