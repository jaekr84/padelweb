        ...
        <div className="min-h-screen bg-grid-carbon text-foreground relative font-sans selection:bg-volt/30 overflow-x-hidden pb-32">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 pt-8 md:pt-12 pb-16">
                ...
                <motion.div
                    ...
                    className="flex gap-1 bg-surface p-1 rounded-2xl border border-hairline w-fit mb-8"
                >
                    {TABS.map((tab) => (
                        <button
                            key={tab.id}
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 relative overflow-hidden group shadow-xl">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                ...
                                                { label: "Finalista", points: "Subcampeón", icon: Medal, color: "text-muted-foreground" },
                                                ...
                                                <div key={i} className="flex items-center justify-between p-3 bg-surface border border-hairline rounded-xl group hover:border-celeste/30 hover:bg-celeste/5 transition-all">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                ...
                                                { label: "Clasificación", desc: "Pase a Playoffs", icon: ArrowUpRight, color: "text-foreground" },
                                            ].map((stat, i) => (
                                                <div key={i} className="flex flex-col p-3 bg-surface border border-hairline rounded-xl group hover:border-azul-primary/30 hover:bg-azul-primary/5 transition-all">
                                ...
                                <div className="pt-8 border-t border-hairline">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground italic">Distribución de Puntos — 26 Inscriptos</h3>
                                    </div>
                                                    ...
                                                    {[
                                                        ...
                                                        <tr key={i} className={`group hover:bg-celeste/5 transition-colors ${row.highlight ? "bg-celeste/10" : ""}`}>
                                                            ...
                                                            <td className="px-4 py-2 text-center">
                                                                <span className={`px-2 py-0.5 rounded-full text-[10px] font-black italic tracking-tighter ${row.highlight ? "bg-celeste text-white" : "bg-surface text-foreground"}`}>
                                                                    {row.total}
                                                                </span>
                                                            </td>
                                                        </tr>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 relative overflow-hidden group shadow-xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {[
                                        ...
                                        <div key={i} className="p-5 bg-surface border border-hairline rounded-xl flex flex-col gap-4 group hover:bg-rosa/5 hover:border-rosa/20 transition-all">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[9px] font-bold text-subtle leading-relaxed uppercase tracking-wider">{card.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="flex flex-col lg:flex-row items-center gap-8">
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="p-6 bg-rojo/5 border border-rojo/10 rounded-xl w-full group-hover:bg-rojo/10 transition-all">
                                            ...
                                            <p className="text-[10px] font-bold text-subtle leading-relaxed uppercase tracking-[0.15em]">
                                    ...
                                    <div className="w-full lg:w-56 p-6 glass-card rounded-xl flex flex-col items-center justify-center text-center shadow-inner relative overflow-hidden group-hover:border-rojo/40 transition-all">
                                        ...
                                        <div className="w-10 h-px bg-surface-raised my-3 relative" />
                        ...
                        >
                                    ...
                                    {[
                                        ...
                                        <div key={i} className={`p-4 rounded-xl border ${c.bg} flex flex-col gap-3`}>
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{c.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="flex items-start gap-4 p-4 bg-surface border border-hairline rounded-xl hover:bg-surface-raised transition-all group/item">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed mb-1">{s.desc}</p>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="space-y-3 mb-6">
                                    {[
                                        ...
                                        <div key={i} className="flex items-start gap-4 p-4 bg-surface border border-hairline rounded-xl hover:bg-celeste/5 hover:border-celeste/15 transition-all">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{s.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="overflow-hidden rounded-xl border border-hairline bg-surface">
                                    <div className="bg-surface px-4 py-3 border-b border-hairline">
                                            ...
                                            <tbody className="divide-y divide-hairline">
                                                {[
                                                    ...
                                                    <tr key={i} className={`hover:bg-celeste/5 transition-colors ${row.qualify ? "bg-celeste/5" : ""}`}>
                                                        <td className="px-4 py-2 text-[9px] font-black text-subtle italic">{row.pos}</td>
                                                        <td className="px-4 py-2">
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div className="space-y-3">
                                        <h3 className="text-[9px] font-black uppercase tracking-[0.3em] text-subtle italic flex items-center gap-2">
                                            <span className="w-5 h-5 rounded-full bg-surface-raised flex items-center justify-center text-[8px]">1</span>
                                            Orden de seeds entre grupos
                                        </h3>
                                        <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">
                                        ...
                                        <div className="space-y-1.5">
                                            {[
                                                ...
                                                <div key={i} className="flex items-center justify-between p-2.5 bg-surface border border-hairline rounded-xl">
                                                    <span className={`px-2 py-0.5 rounded text-[8px] font-black ${s.color}`}>{s.seed}</span>
                                                    <span className="text-[9px] font-bold text-subtle uppercase tracking-widest">{s.from}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                    <div className="space-y-3">
                                        <h3 className="text-[9px] font-black uppercase tracking-[0.3em] text-subtle italic flex items-center gap-2">
                                            <span className="w-5 h-5 rounded-full bg-surface-raised flex items-center justify-center text-[8px]">2</span>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {[
                                        ...
                                        <div key={i} className={`p-5 rounded-xl border ${cfg.color} flex flex-col gap-3`}>
                                            ...
                                            <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{cfg.desc}</p>
                                            <p className="text-[8px] font-black text-muted-foreground/45 uppercase tracking-widest italic border-t border-hairline pt-2">{cfg.example}</p>
                                        </div>
                                    ))}
                                </div>
                            </motion.section>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex items-start gap-4 p-4 bg-surface border border-hairline rounded-xl hover:bg-celeste/5 hover:border-celeste/15 transition-all group/item">
                                            <div className={`w-8 h-8 shrink-0 rounded-lg flex items-center justify-center text-[9px] font-black italic ${s.color}`}>{s.priority}</div>
                                            <div className="flex-1">
                                                <p className="text-[10px] font-black uppercase italic tracking-widest mb-1 group-hover/item:text-celeste transition-colors">{s.label}</p>
                                                <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{s.desc}</p>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="space-y-2 mb-6">
                                    {[
                                        ...
                                        { rank: "3°", label: "Games Ganados", desc: "Total de games anotados en toda la fase de grupos. Desempate final para casos de empate absoluto.", color: "text-muted-foreground", bg: "bg-surface border-hairline" },
                                    ].map((c, i) => (
                                        <div key={i} className={`flex items-start gap-4 p-4 rounded-xl border ${c.bg}`}>
                                            <span className={`text-xl font-black italic tracking-tighter shrink-0 w-8 ${c.color}`}>{c.rank}</span>
                                            <div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-1.5">
                                            {[
                                                ...
                                                <div key={i} className="flex items-center gap-3 p-2 bg-surface border border-hairline rounded-lg">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                ...
                                                <div key={i} className="flex items-center justify-between p-3 bg-surface border border-hairline rounded-xl">
                                                    <span className="text-[9px] font-black uppercase italic tracking-tight text-muted-foreground">{b.bracket}</span>
                                                    <div className="flex items-center gap-3">
                                                        <span className="text-[8px] font-black text-subtle uppercase tracking-widest">{b.rounds}</span>
                    ...
                    {activeTab === "cancha-abierta" && (
                        ...
                        >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    {[
                                        ...
                                        <div key={i} className={`p-5 rounded-xl border ${pos.color} flex flex-col gap-3`}>
                                            ...
                                            <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{pos.desc}</p>
                                            <p className="text-[8px] font-black text-subtle uppercase tracking-widest italic border-t border-hairline pt-2">{pos.ideal}</p>
                                        </div>
                                    ))}
                                </div>
                            </motion.section>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="p-5 bg-surface border border-hairline rounded-xl hover:bg-surface-raised transition-all">
                                            <div className="flex items-start gap-4">
                                                <m.icon className="w-4 h-4 mt-0.5 text-subtle shrink-0" />
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-3 mb-2">
                                                        <span className={`px-2.5 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest border ${m.badge}`}>{m.mode}</span>
                                                    </div>
                                                    <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-wider leading-relaxed mb-2">{m.rule}</p>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                {/* Las 3 combinaciones */}
                                <div className="mb-8">
                                    <h3 className="text-[9px] font-black uppercase tracking-[0.3em] text-subtle italic mb-3 flex items-center gap-2">
                                        <span className="w-5 h-5 rounded-full bg-surface-raised flex items-center justify-center text-[8px]">1</span>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                        {[
                                            ...
                                            <div key={i} className="p-4 bg-surface border border-hairline rounded-xl text-center">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {[
                                            ...
                                            { label: "Uno o ambos son 'Ambos'", value: "0 pts", icon: CircleDot, color: "text-subtle", bg: "bg-surface border-hairline", desc: "Neutral: no suma ni resta penalidad posicional." },
                                            ...
                                            <div key={i} className={`flex items-start gap-4 p-4 rounded-xl border ${row.bg} transition-all`}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[8px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{row.desc}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                            ...
                            <motion.section variants={item} className="glass-card rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="flex items-start gap-4 p-4 bg-surface border border-hairline rounded-xl hover:bg-azul-primary/5 hover:border-azul-primary/20 transition-all group/item">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between mb-1">
                                                    ...
                                                    <span className={`text-[7px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full ${s.priority === "Alta" ? "bg-rojo/20 text-rojo" : s.priority === "Media" ? "bg-amber-500/20 text-amber-400" : "bg-surface-raised text-muted-foreground"}`}>{s.priority}</span>
                                                </div>
                                                <p className="text-[9px] font-bold text-subtle uppercase tracking-wider leading-relaxed">{s.desc}</p>
                                            </div>
                                        </div>
