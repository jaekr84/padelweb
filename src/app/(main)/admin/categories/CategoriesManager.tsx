                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                        <div className="flex flex-col gap-1.5">
                            <div className="flex items-center gap-3 mb-1">
                                ...
                                <div>
                                    <span className="text-[9px] font-black uppercase tracking-[0.4em] text-emerald-400 italic">Admin Tactical Console</span>
                                ...
                                <tbody className="divide-y divide-border/50">
                                    ...
                                    <tr className="bg-emerald-500/[0.03] group hover:bg-emerald-500/[0.06] transition-colors border-b border-emerald-500/10">
                                        <td className="px-4 py-2 text-center">
                                            <div className="w-7 h-7 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 text-[10px] font-black italic">
                                                +
                                            </div>
                                        </td>
