            ...
            <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
                <header>
                    <div className="flex items-center gap-2 mb-1">
                        <Swords className="w-4 h-4 text-volt" />
                        <span className="label-tech text-[8px] text-volt">Modalidad individual</span>
                    </div>
                    <h1 className="heading-sport text-3xl sm:text-4xl text-white">Desafío</h1>
                    <p className="text-[12px] text-slate-400 mt-2 max-w-xl leading-relaxed">
                        Te inscribís solo, armás pareja con quien quieras y la podés cambiar cuando quieras. Los puntos
                        son <span className="text-white font-bold">siempre tuyos</span>, no de la pareja, y cada desafío
