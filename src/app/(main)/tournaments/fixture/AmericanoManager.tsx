                                    ...
                                    return (
                                        <div key={tab} className="flex-1 flex flex-col items-center relative z-10">
                                            <button
                                                ...
                                                className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-500 border-2 ${isCurrent ? "bg-blue-600 border-blue-400 text-white shadow-xl shadow-blue-500/20 scale-110" :
