                                ...
                                <div className="bg-card/40 backdrop-blur-xl border border-border/50 rounded-[2.5rem] p-8 shadow-2xl sticky top-32 space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex flex-wrap gap-2 pt-2">
                                            ...
                                            {standings.length > 2 && (
                                                <button
                                                    onClick={() => setQualCount(standings.length)}
                                                    className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${qualCount === standings.length
                                                        ? "bg-blue-600 border-blue-500 text-white shadow-lg shadow-blue-600/20 scale-105"
                                                        : "bg-emerald-500/5 border-emerald-500/10 text-emerald-600/60 hover:bg-emerald-500/10"
                                                        }`}
                                                >
