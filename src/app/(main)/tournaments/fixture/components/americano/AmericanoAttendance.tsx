    ...
    return (
        <div className="w-full space-y-4 pb-32">
            <div className="text-center space-y-0.5">
                <h2 className="text-base md:text-lg font-black text-foreground tracking-tighter uppercase italic leading-none">Lista de Asistencia</h2>
                <p className="text-azul-primary text-[7px] font-black uppercase tracking-[0.3em]">Verificación y Presentismo</p>
            </div>

            {/* Control Bar */}
            <div className="flex flex-col md:flex-row items-center justify-between gap-2 p-2 bg-card/40 backdrop-blur-xl border border-border/50 rounded-xl shadow-xl">
                                ...
                                >
                                    <td className="px-3 py-1">
                                        <div className="flex items-center gap-2">
                                            <div className={`w-6 h-6 rounded-lg flex items-center justify-center shrink-0 transition-all ${isPresent ? "bg-azul-primary text-white" : "bg-muted text-foreground/20"}`}>
