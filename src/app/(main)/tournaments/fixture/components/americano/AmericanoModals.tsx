                    ...
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center space-y-8">
                                <div className="w-24 h-24 rounded-full bg-celeste/10 flex items-center justify-center relative">
                                    <div className="absolute inset-0 rounded-full bg-celeste/5 animate-ping" />
                                    <Users2 className="w-10 h-10 text-celeste" />
                                </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isAlreadyInMatch ? (
                                            ...
                                            <ChevronRight className="w-4 h-4 text-celeste" />
                                        )}
                                    </button>
                                );
                            })
