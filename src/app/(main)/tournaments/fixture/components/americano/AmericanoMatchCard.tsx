                ...
                {names.map((name, i) => {
                    ...
                    return (
                        <MiniProfileCard
                            ...
                            onSwap={() => !readOnly && !m.confirmed && setReplacingPlayer(slot as Player)}
                        ...
                        <>
                            ...
                            {isReadyToStart && (
                                <motion.button
                                    ...
                                    className="w-10 h-10 flex items-center justify-center rounded-full bg-celeste text-carbon-950 shadow-[0_0_20px_rgba(59,130,246,0.4)] border border-hairline-strong hover:bg-celeste-light transition-all"
    ...
    return (
        <div className="flex flex-col items-center gap-1 min-w-[44px]">
            ...
            <motion.div
                ...
                `}
            >
                <span className="text-xl font-black italic tabular-nums tracking-tighter relative z-10 text-black">
                    {score ?? 0}
                </span>
            </motion.div>
...
function MiniProfileCard({
    ...
    return (
        <div
            onClick={onCardClick}
            className={`
                relative group/card cursor-pointer transition-all duration-500 w-[80px] hover:scale-[1.1] hover:z-10
            `}
        >
            ...
            {!readOnly && !isFinished && !isBye && !isTBD && (
                <button
                    ...
                    className={`
                        ...
                        bg-background text-muted-foreground border-hairline hover:bg-celeste hover:text-carbon-950 hover:border-hairline-strong hover:scale-105 active:scale-95
                    `}
            ...
            <div
                className={`
                    ...
                    ${isWinner ? "bg-emerald-500 shadow-lg" : "bg-surface-raised"}
                `}
                style={cardStyle}
            >
                <div
