                    ...
                    <table className="w-full text-left">
                        <thead className="bg-muted text-[7px] font-black uppercase tracking-widest text-muted-foreground border-b border-hairline">
                            <tr>
                                ...
                                <th className="px-3 py-1 text-center text-celeste">Dif</th>
                            </tr>
                        </thead>
                                ...
                                return (
                                    <tr key={s.playerId} className={`group hover:bg-surface transition-all ${s.player.withdrawn ? "opacity-50" : isPlaying ? "bg-celeste/[0.04]" : isDone ? "bg-celeste/[0.01]" : ""}`}>
                                                ...
                                                {!readOnly && (
                                                    <div className="flex items-center gap-1">
                                                        <button
                                                            ...
                                                            title="Reemplazar"
                                                            className="w-5 h-5 rounded flex items-center justify-center bg-celeste/10 text-celeste hover:bg-celeste/20 transition-all opacity-0 group-hover:opacity-100 active:scale-90"
                                                        >
                                        ...
                                        <td className="px-3 py-1 text-center font-black text-[9px]">
                                            <span className={s.points >= 0 ? "text-celeste" : "text-rojo"}>
