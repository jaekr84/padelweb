                    ...
                    {isPlayerModalOpen && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                            ...
                            <motion.div
                                ...
                                className="relative w-full max-w-5xl bg-card border border-border rounded-[2rem] overflow-hidden shadow-2xl flex flex-col md:h-[85vh]"
                            >
                                {/* Header */}
                                <div className="px-8 py-6 border-b border-border bg-muted/40 flex items-center justify-between shrink-0">
                                    <div>
                                        <h3 className="text-2xl font-black uppercase italic tracking-tighter text-foreground leading-none">Inscribir Jugador</h3>
                                        <p className="text-foreground/80 text-[10px] font-black tracking-[0.2em] uppercase mt-2">Elegí un jugador existente o registralo manualmente</p>
                                    </div>
                                    <button 
                                        onClick={() => setIsPlayerModalOpen(false)}
                                ...
                                <div className="flex-1 overflow-y-auto no-scrollbar p-8">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                                        ...
                                        {/* Columna Izquierda: Manual y Bot */}
                                        <div className="space-y-6">
                                            {/* Manual Registration Form */}
                                            <div className="p-6 bg-blue-600/5 border border-blue-500/20 rounded-[2rem] space-y-4">
                                        ...
                                        <div className="flex flex-col space-y-4 md:h-full">
                                            <div className="text-[10px] font-black uppercase text-foreground/40 tracking-[0.3em] flex items-center gap-2 mb-2">
                                            ...
                                            <div className="space-y-4">
                                                <div className="relative group">
                                                    ...
                                                    <input 
                                                        ...
                                                        value={searchQuery}
                                                        onChange={(e) => setSearchQuery(e.target.value)}
                                                        className="w-full bg-muted/30 border border-border rounded-xl py-4 pl-12 pr-4 text-sm font-bold placeholder:text-foreground/50 outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/5 transition-all text-foreground shadow-sm"
                                                    />
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div className="relative group">
                                                        <select 
                                                            value={categoryFilter}
                                                            onChange={(e) => setCategoryFilter(e.target.value)}
                                                            className="w-full bg-muted border border-border rounded-xl py-3 px-4 text-[10px] font-black uppercase italic outline-none focus:border-blue-500 appearance-none cursor-pointer text-foreground pr-10"
                                                        >
                                                    ...
                                                    <div className="relative group">
                                                        <select 
                                                            ...
                                                            className="w-full bg-muted border border-border rounded-xl py-3 px-4 text-[10px] font-black uppercase italic outline-none focus:border-blue-500 appearance-none cursor-pointer text-foreground pr-10"
                                                        >
                                                            <option value="all">Género (Cualquiera)</option>
                                            ...
                                            {/* Results Section */}
                                            <div className="flex-1 min-h-[300px] overflow-y-auto no-scrollbar space-y-2 bg-muted/10 rounded-3xl p-2 border border-border/50">
                                                {isLoadingAvailable ? (
                                                    ...
                                                    if (filtered.length === 0) {
                                                        return (
                                                            <div className="py-20 text-center flex flex-col items-center gap-4 bg-transparent">
                                                    ...
                                                    return filtered.map(p => (
                                                        <button
                                                            ...
                                                            className="w-full flex items-center justify-between p-4 bg-card hover:bg-blue-600 hover:text-white border border-border hover:border-blue-500 rounded-2xl transition-all group active:scale-[0.98] shadow-sm hover:shadow-blue-500/20"
                                                        >
                                                            <div className="flex items-center gap-4">
                                                                        ...
                                                                        {p.gender && (
                                                                            <>
                                                                                ...
                                                                                <div className="text-[8px] text-foreground/40 group-hover:text-white/60 font-black uppercase tracking-widest">
                                                                                    {p.gender === 'masculino' ? '♂' : p.gender === 'femenino' ? '♀' : '⚤'}
                                                                                </div>
                                                                            </>
                                                                        )}
                                                                    </div>
